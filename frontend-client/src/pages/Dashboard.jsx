      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-blue-600">Create, manage and edit your resumes</p>
          </div>
          <button 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {resumes.map((resume) => (
            <div
              key={resume._id}
              onClick={() => !editingId && navigate(`/resume/edit/${resume._id}`)}
              ...
              <div className="p-5 h-full flex flex-col">
                ...
                <div className="flex justify-between items-start mb-3">
                  {editingId === resume._id ? (
                    ...
                    <>
                      <h2 className="text-lg font-semibold text-blue-800 pr-6">{resume.title}</h2>
                      <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="dropdown relative">
                          <button 
                            onClick={(e) => {
                              e.stopPropagation();
                              setEditingId(editingId === resume._id ? null : resume._id);
        ...
        {resumes.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-blue-800 mb-2">No resumes yet</h3>
            <p className="text-blue-600 mb-4">Create your first resume to get started</p>
            <button
              onClick={() => navigate("/resume/create")}
